---
title: "Demonstrating hyperliquid"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Demonstrating hyperliquid}
...
This vignette demonstrates the two main functions in `hyperliquid`:
...
```{r setup}
box::use(hyperliquid[ add, sum_array_cpp ])
```
