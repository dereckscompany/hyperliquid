...
- **Pure-R Ethereum signing via [`ethsign`](https://github.com/dereckscompany/ethsign).** secp256k1 ECDSA, Keccak-256, and EIP-712 come from our standalone pure-R `ethsign` package; the Hyperliquid-specific msgpack action hash lives here. No compiled code, and verified byte-identical to the official Python and Rust SDK test vectors.
